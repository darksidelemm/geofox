...
// $Id: RF22.h,v 1.20 2011/11/24 00:29:58 mikem Exp mikem $
//
...
/// from http://www.open.com.au/mikem/arduino/RF22/RF22-1.13.zip
...
///
/// The Arduino UNO is known not to work with RF22. 
/// It appears that something in the Uno is interfering with MISO pin, preventing 
/// the RFM initialisation completing. Miso is held at 0 when I would expect the 
/// RFM22 to output data on MISO. I suspect it is the U8A USP interface chip (its 
/// the only other thing connected to MISO. And if I power the Uno + RFM22 from a 
/// battery instead of USB, it works fine. rubinoae reports that installing different firmware 
/// in the U8A fixes this problem but that has not been tested by me.
///
/// \par Installation
///
