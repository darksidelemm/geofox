...
// $Id: RF22.cpp,v 1.14 2011/11/24 00:30:03 mikem Exp mikem $
...
PROGMEM static const RF22::ModemConfig MODEM_CONFIG_TABLE[] =
{
    ...
    { 0x51, 0x03, 0xE8, 0x60, 0x20, 0xC5, 0x00, 0x23, 0x4F, 0x10, 0x2B, 0x80, 0x60, 0x01, 0x06, 0x2c, 0x21, 0x08 },
...
boolean RF22::init()
{
    ...
    // to allow RF22 device to "settle".  100 ms may be overkill.
    pinMode(SCK, OUTPUT);
    pinMode(MOSI, OUTPUT);
    pinMode(MISO, INPUT);
    pinMode(SS, OUTPUT);
